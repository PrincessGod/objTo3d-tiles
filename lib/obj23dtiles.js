                    ...
                    return fsExtra.readJson(options.customBatchTable)
                        .then(function(customBatchTable) {
                            if(!(customBatchTable.batchId && customBatchTable.batchId.length === batchTableJson.batchId.length)) {
                                throw new DeveloperError('Custom BatchTable should have a proper "batchId" Array.');
                            }
...
Object.assign(obj23dtiles.defaults, {
    ...
    /**
     * Sets the default BatchTable Json file path, should have proper property "batchId" Array.
     * @type String
     * @default undefined
     */
